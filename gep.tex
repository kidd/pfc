...
representació ideada per Cândida Ferreira \cite{ferreira:2007}, on per la pròpia construcció del
...
operands tenien un màxim de aritat 2 \ref{table:func-aritat}.
