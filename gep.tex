...
dades funcionals XXX(funcionals?), és a dir que no són valors concrets 
...
Aquest projecte ha estat el més difícil d'implementar i dissenyar, ja que hem
...
implementat una estructura amb nodes, i un arbre tipus template.
...
en un cromosoma donat, al transformar-lo a genotip, les fulles seran totes
...
seran els nodes arrel de l'arbre final.
...
es manté la simplicitat gracies a Karva notation\ldots
