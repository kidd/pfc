...
tipus d'enllaços, etc. Per exemple, una molècula pot trobarse en la natura
...
combinacions, s'utilitza un sofware especific, que fa la combinatòria i genera
...
informació sobre l'usuari la disposem desde el moment que s'autentifica a la web
...
aleatòria, amb numeros en coma flotant entre -1 i 1.  L'algorisme genètic no ens
