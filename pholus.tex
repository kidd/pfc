...
HELIOS es basa en la superposició de camps mol·leculars entre qualsevol compost i un lligand de referència. Però HELIOS, no només considera la superposició generada per càrregues formals, sinó també altres tipus relacionades amb el comportament dinàmic; així, es fan diferents superposicions entre parells de mol·lècules es duen a terme a la vegada. 
...
\begin{figure}[h]
\begin{center}
\includegraphics{pholus/pholus1.png}
\end{center}
\caption{càlcul 1}
...
\begin{figure}[h]
\begin{center}
\includegraphics{pholus/pholus2.png}
\end{center}
\caption{càlcul 2}
...
\begin{figure}[h]
\begin{center}
\includegraphics{pholus/pholus3.png}
\end{center}
\caption{càlcul 3}
...
\begin{figure}[h]
\begin{center}
\includegraphics{pholus/pholus4.png}
\end{center}
\caption{càlcul 4}
...
\begin{figure}[h]
\begin{center}
\includegraphics{pholus/pholus5.png}
\end{center}
\caption{càlcul 5}
...
\begin{figure}[h]
\begin{center}
\includegraphics{pholus/pholus6.png}
\end{center}
\caption{càlcul 6}
...
\begin{figure}[h]
\begin{center}
\includegraphics{pholus/pholus7.png}
\end{center}
\caption{càlcul 7}
...
\begin{figure}[h]
\begin{center}
\includegraphics{pholus/pholus8.png}
\end{center}
\caption{càlcul 8}
...
\begin{figure}[h]
\begin{center}
\includegraphics{pholus/pholus9.png}
\end{center}
\caption{càlcul 9}
...
\begin{figure}[h]
\begin{center}
\includegraphics{pholus/pholus10.png}
\end{center}
\caption{càlcul 10}
