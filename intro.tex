...
\begin{figure} \centering \includegraphics[width=4in]{ga}
...
\begin{figure} \centering \includegraphics[width=4in]{rwsgraph.png}
...
\begin{figure} \centering \includegraphics[width=4in]{rank1.png}
...
%\begin{figure} \centering \includegraphics[width=2in]{GA/sus}
%\caption{\label{fig:sus}Exemple simplificat del \emph{stochastic universal
%sampling}. En aquest cas serien seleccionats: A, A, B, C, D, D, F i H}
%\end{figure}
...
%Aquesta teorema diu que els individus bons, ho són per que tenen un bon patró.
...
%\emph{fitness} no es veja afectat per els valors que poden prendre altres gens.
