...
Aquesta bellesa i elegància de la programació d'expressions genètiques és de per
sí impressionant, però a més a més, aquesta és la clau del funcionament de GEP.
Aquest nucli
%XXX
...
imlpementacions més complertes estàn a (\ref{XXX Capitol GEP})
