...
\caption{\label{fig:rank1}Optimització procés}
\end{figure}
...
\subsubsection{Programació Genètica} % (fold)
\label{ssub:Programacio Genetica}

% subsubsection Programació Genètica (end)
