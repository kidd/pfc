...
diferents llenguatges de programació.Figure~\ref{fig:401px-Orb.svg.png}

\begin{figure}[h]
\centering
\includegraphics[width=13cm,height=7cm]{G:401px-Orb.svg.png}
\caption{Model de Client-servidor que necesitem}
\label{fig:401px-Orb.svg.png}
\end{figure} 
