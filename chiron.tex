...
Sabem doncs, que per al projecte, en l'estat actual no és necessari que
...
\begin{itemize}
	\item EODEV en c++  DONE
	\item Els arxius de configuració de eodev es creen amb Template Toolkit DONE
	\item La comunicació amb la bbdd es fa amb DBIX\dots Class DONE
	\item la implementacio de SOAP, s'utilitza SOAP\dots Lite i WSDL\dots SOAP.
		Soap vs REST
	\item MysQl vs TC vs MongoDB
\end{itemize}

\subsubsection{Bases de Dades} % (fold)
\label{ssub:Bases de Dades}
% subsubsection Bases de Dades (end)
