...
possibles variants i combinacions de ramificacions, i mesurant la energia %XXX (disipada?)
	...
	estem fent més que desacoblar la avaluació del procés de creuaments,
...
avaluats, ja que hem reduit molt l'espai de búsqueda sobre el que ataquem.
...
%dev.off()
	...
	R(XXX), i ens permet dir coses com per exemple, que \textbf{avaluant un XXX
