...
\begin{itemize}
	...
	Aparentment, sempre que calculem un individu nou, hauríem de guardar-nos
...
visualitzacions.
% subsubsection Emmagatzematge de les dades (end)
...
Tecnologies per a executar RPCs (Remote procedure call) n'hi ha moltes
...
\section{Resultats} % (fold)
	...
	dades experimentals, tenint així una resposta per a cada possible individu
...
%dev.off()
	...
	Veiem que hi ha una gran densitat d'experiments on evaluant un percentatge
	molt petit del espai de cerca, trobem el millor individu de tots, o bé un
	individu molt pròxim al millor.
	...
	R\footnote{\url{http://www.r-project.org/}}, i ens permet dir coses com per exemple,
	que \textbf{avaluant un 10\% de l'espai de cerca, ens quedem a menys de
	1.68 del millor en un 72.25\% dels casos}, o bé la més interessant 
	\textbf{avaluant un 12\% de l'espai de cerca, trobem la millor combinació
