...
\frame{\frametitle{Índex}\tableofcontents} 
...
\begin{frame}
	...
	\pause
	\framebox{\includegraphics[height=0.9\textheight,width=0.9\textwidth]{images/jirafa11.jpg}}
\end{frame}
...
\begin{frame}
	...
	Exemple de resultat:
		\framebox{\includegraphics[height=0.5\textheight,width=0.6\textwidth]{../pholus/pholus7.png}}
\end{frame}
...
\begin{frame}
	...
	\framebox{\includegraphics[height=0.6\textheight,width=0.9\textwidth]{images/Rai_Chiron.jpeg}}
...
\begin{frame}
	...
	\begin{center}
		\framebox{\includegraphics[scale=0.4]{images/1-5.jpg}}
	\end{center}
	\begin{itemize}
...
\begin{frame}
	...
	\begin{columns}[c]
		...
		+/*abcd
		\end{center}
		\framebox{\includegraphics[height=0.5\textheight,width=0.7\textwidth]{images/pt01.png}}
...
\begin{frame}
	\frametitle{Pholus}
		\framebox{\includegraphics[angle=90,height=0.5\textheight,width=1\textwidth]{../pholus/pholus-gantt.png}}

	Pholus = \EUR{3500}. Aproximadament 2 mesos i mig
\end{frame}

\begin{frame}
	\frametitle{Chiron}
		\framebox{\includegraphics[angle=90,height=0.5\textheight,width=1\textwidth]{../chiron/chiron-gantt.png}}

	Chiron = \EUR{3000}. Aproximadament 2 mesos.
\end{frame}

\begin{frame}
	\frametitle{GEP}
		\framebox{\includegraphics[angle=90,height=0.5\textheight,width=1\textwidth]{../gep-gantt.png}}

	GEP  = \EUR{3000}. Aproximadament 2 mesos.
\end{frame}
...
\begin{frame}
	\frametitle{Memòria i cost total}
		...
		\framebox{\includegraphics[height=0.3\textheight,width=0.8\textwidth]{images/memo.png}}
		\end{center}

		El cost total ha estat d'uns \EUR{9500} aproximadament.
...
\begin{frame}
	...
	\begin{center}
	\framebox{\includegraphics[height=0.5\textheight,width=0.6\textwidth]{images/mlink.jpg}}
	\end{center}
