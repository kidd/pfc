...
%\section{Objetivos y motivaciÃ³n} 
%\frame{\frametitle{ProblemÃ¡tica} 
%Los hdd crecen y crecen, y nosotros no somos capaces de organizar toda la info
%\pause
%\begin{itemize}
%\item  Crear un programa de fÃ¡cil interface, que permita moverme por mi hdd.
%\item  Funciona en X, para cualquier wm.
%\item  Tiene las mÃ­nimas dependencias posibles.
%\item  Tiene que ser 'intuitivo' para los usuarios (DWIM)
%\item  Tiene que ser extensible (a mas o menos nivel)
%\end{itemize}
%}

%\frame{\frametitle{Â¿QuÃ© aplicaciones existen?}
%\begin{itemize}
%\item  Beagle \\
%Daemons!!
%\pause
...
%\begin{itemize}
%\item  Permite buscar y abrir archivos rÃ¡pidamente
...
%\item  No requiere utilizar ningÃºn mÃ³dulo ni ningun gestor de ventanas para funcionar (no todas las funcionalidades estaran activas)
%\item  MÃ­nima heurÃ­stica para facilitar su uso
%\end{itemize}
%}

%\section{AproximaciÃ³n} 
%\subsection{Primera AproximaciÃ³n}
...
%\begin{frame}[fragile]
%\frametitle{Â¿Buscamos cada vez?}
...
%\begin{itemize}
%\item Checkear archivo de configuraciÃ³n
%\item Preguntar por una extensiÃ³n/comando/orden
%\begin{itemize}
%\item si es extensiÃ³n, pedir un patrÃ³n.
%\item si es una aplicaciÃ³n, ejecutarla
%\item si es una orden, ejecutarla. (gen, ff, vi)
%\end{itemize}
%\item Si es una extensiÃ³n nueva pedimos una aplicaciÃ³n con la que abrir esos archivos.    
%\end{itemize}
%\begin{center}
%Usamos prefijos para distinguir entre .tex (archivo) y tex(aplicaciÃ³n)
%\end{center}
%\end{frame}

%\begin{frame}
%\frametitle{Prefijos y heurÃ­stica}
%\begin{itemize}
%\item  .extensiÃ³n
%\item -ejecutable
%\item ,ventana
%\pause
%\item Si no ponemos ningÃºn prefijo, y entramos una extensiÃ³n conocida, rf lo interpreta como EXTENSION.
%\item Si no es conocida y es un comando, se ejecuta el comando
%\item Si no es conocida y no es ningun comando, se agrega como nueva extensiÃ³n
%\end{itemize}
%\end{frame}
...
%\begin{frame}
%\frametitle{Flags}
%El usuario tiene que poder usar el programa sin tocar ni una linea de cÃ³digo.
%\begin{itemize}
%\item --all
%\item --case
%\item --conffile
...
%\begin{itemize}
%\item Refactorizar cÃ³digo
%\item Utilizar sqlite para localizar archivos.
%\item hacer 'plugins' para buscar streamings de mÃºsica
%\item --loop flag
%\item --tmpcmd flag
%\end{itemize}
%\end{frame}
