...
\begin{frame}
	\frametitle{Pholus}
		\framebox{\includegraphics[height=0.5\textheight,width=1\textwidth]{../pholus/pholus-gantt.png}}
\end{frame}

\begin{frame}
	\frametitle{Chiron}
		\framebox{\includegraphics[height=0.5\textheight,width=1\textwidth]{../chiron/chiron-gantt.png}}
\end{frame}

\begin{frame}
	\frametitle{GEP}
		\framebox{\includegraphics[height=0.5\textheight,width=1\textwidth]{../gep-gantt.png}}
\end{frame}
